...
The driver routine that should be used depends on the computation andthat can be calculated depend on the 
The derivatives that can be computed depend on the function
Calculate derivative objects after `trace_off(tag)` using
