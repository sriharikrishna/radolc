...
res0 <- optim(c(1.2,1), fr, method = "L-BFGS-B", control = list(type = 3, trace = 2))

res1 <- optim(c(1.2,1), fr, grr, method = "L-BFGS-B", control = list(type = 3, trace = 2))

res2 <- optim(c(1.2,1), fr, grrADOLC, method = "L-BFGS-B", control = list(type = 3, trace = 2))
